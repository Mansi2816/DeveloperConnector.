...
return (
  ...
  <form className="form" onSubmit={e=> {
    ...
    <div className="form-group">
      <p><input type="checkbox" name="current" checked={current} defaultValue value={current} onChange={e=> {setFormData({...formData, current: !current})
    ...
    <div className="form-group">
      <textarea name="description" cols={30} rows={5} placeholder="Job Description" value={description} onChange={e=>onChange(e)} defaultValue={""} />
    </div>
